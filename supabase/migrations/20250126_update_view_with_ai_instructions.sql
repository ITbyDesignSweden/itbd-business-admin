-- Migration: Update organizations_with_credits VIEW to include custom_ai_instructions
-- Purpose: Add custom_ai_instructions and business_profile to view for AI Architect context
-- Date: 2025-01-26

-- Drop existing view
DROP VIEW IF EXISTS public.organizations_with_credits;

-- Recreate view with AI instruction fields
...
COMMENT ON VIEW public.organizations_with_credits IS 
  'View combining organizations with their aggregated credit balance, plan details, and AI context. 
   Includes business_profile and custom_ai_instructions for AI Architect personalization.
